...
execute if score .pv const matches 6 run scoreboard players set .pv const 1
...
data modify entity @e[tag=LRID,limit=1] transformation.scale set value [1.0f,1.0f,1.0f]
schedule function mace:buttons/lives/animationplusl 2t append
